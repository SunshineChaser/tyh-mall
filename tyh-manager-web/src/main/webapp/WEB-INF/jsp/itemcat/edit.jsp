				...
				<div style="padding: 15px;">
					...
					<div class="addform">
						...
						<form class="form-horizontal col-md-offset-3" 
						 	action="${pageContext.request.contextPath}/manager/itemcat/edit" 
						 		method="post">
						  ...
						  <div class="form-group">
						    <label for="catstate" class="col-sm-2 col-md-2 control-label">类型状态</label>
						    <div class="col-sm-10 col-md-5">
						      <select class="form-control" id="catstate" name="catstate">
						        <c:choose>
						        	<c:when test="${item.catstate==1 }">
						  ...
						  <div class="form-group">
						    <label for="catorder" class="col-sm-2 col-md-2 control-label">类型排序</label>
						    <div class="col-sm-10 col-md-5">
						      <select class="form-control" id="catorder" name="catorder">
						        <c:forEach begin="0" end="9" step="1" var="order">
						        	<c:choose>
						        		<c:when test="${order==item.catorder}">
