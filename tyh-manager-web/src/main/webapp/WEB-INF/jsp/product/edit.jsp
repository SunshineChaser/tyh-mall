				...
				<div style="padding: 15px;">
					...
					<div class="editform">
						<form class="form-horizontal col-md-offset-1" 
							action="${pageContext.request.contextPath}/manager/product/edit"
						 		method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label for="pname" class="col-sm-2 col-md-2 control-label">商品名称</label>
							...
							<div class="form-group">
								<label for="catid" class="col-sm-2 col-md-2 control-label">商品类型</label>
								<div class="col-sm-10 col-md-5">
									<select class="form-control" name="catid" id="catid">
										<c:forEach items="${catlist}" var="cat">
											<c:choose>
												<c:when test="${product.catid==cat.catid}">
							...
							<div class="form-group">
								<label for="pdig" class="col-sm-2 col-md-2 control-label">单位</label>
								<div class="col-sm-10 col-md-5">
									<input type="text" class="form-control" id="pdig" name="pdig" value="${product.pdig}" />
								</div>
							</div>
							<div class="form-group">
								<label for="pno" class="col-sm-2 col-md-2 control-label">商品条码</label>
								<div class="col-sm-10 col-md-5">
									<input type="text" class="form-control" id="pno" name="pno" value="${product.pno}" />
								</div>
							</div>
							<div class="form-group">
								<label for="pkeywords" class="col-sm-2 col-md-2 control-label">关键词</label>
								<div class="col-sm-10 col-md-5">
									<input type="text" class="form-control" id="pkeywords" name="pkeywords" value="${product.pkeywords}" />
								</div>
							</div>
							<div class="form-group">
								<label for="pprice" class="col-sm-2 col-md-2 control-label">商品价格</label>
								<div class="col-sm-10 col-md-5">
									<input type="text" class="form-control" id="pprice" name="pprice" value="${product.pprice}" />
								</div>
							</div>
							<div class="form-group">
								<label for="psaleprice" class="col-sm-2 col-md-2 control-label">销售价格</label>
								<div class="col-sm-10 col-md-5">
									<input type="text" class="form-control" id="psaleprice" name="psaleprice" value="${product.psaleprice}" />
								</div>
							</div>
							<div class="form-group">
								<label for="psalenum" class="col-sm-2 col-md-2 control-label">销售量</label>
								<div class="col-sm-10 col-md-5">
									<input type="text" class="form-control" id="psalenum" name="psalenum" value="${product.psalenum}" />
								</div>
							</div>
							<div class="form-group">
								<label for="pstock" class="col-sm-2 col-md-2 control-label">库存量</label>
								<div class="col-sm-10 col-md-5">
									<input type="text" class="form-control" id="pstock" name="pstock" value="${product.pstock}" />
								</div>
							</div>
							<div class="form-group">
								<label for="pdes" class="col-sm-2 col-md-2 control-label">商品说明</label>
								<div class="col-sm-10 col-md-5">
									<textarea class="form-control" rows="3" id="pdes" name="pdes">${product.pdes}</textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="phot" class="col-sm-2 col-md-2 control-label">是否热卖</label>
								<div class="col-sm-10 col-md-5">
									<select class="form-control" name="phot">
										<c:choose>
											<c:when test="${product.phot==1 }">
							...
							<div class="form-group">
								<label for="pfirst" class="col-sm-2 col-md-2 control-label">是否首推</label>
								<div class="col-sm-10 col-md-5">
									<select class="form-control" name="pfirst">
										<c:choose>
											<c:when test="${product.pfirst==1 }">
							...
							<div class="form-group">
								<label for="pstate" class="col-sm-2 col-md-2 control-label">商品状态</label>
								<div class="col-sm-10 col-md-5">
									<select class="form-control" name="pstate">
										<c:choose>
											<c:when test="${product.pstate==1 }">
							...
							<div class="form-group">
								...
								<div class="layui-upload col-sm-10 col-md-5">
									<input type="file" name="file" id="file" /> 
									<div class="layui-upload-list">
										<img class="layui-upload-img" id="imgPreview" style="width:100px;height:100px" src="${fserver}${product.pimg}">
									</div>
							</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-3">
									...
									<a class="btn btn-default" href="http://127.0.0.1:8080/manager/product/list" role="button">返回</a>
								</div>
							</div>
						</form>
					</div>
